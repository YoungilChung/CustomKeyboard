...
Dictionary SpellChecker::corrections(const std::string &word) {
    Vector result;
...
void SpellChecker::known(Vector &results, Dictionary &candidates) {
...
void SpellChecker::editWord(const std::string &word, Vector &result) {
